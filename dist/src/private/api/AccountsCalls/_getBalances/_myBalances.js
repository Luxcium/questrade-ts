...
exports._myBalances = function (myBalances) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    ...
    return tslib_1.__generator(this, function (_e) {
        _a = myBalances.perCurrencyBalances, perCADcurrent = _a[0], perUSDcurrent = _a[1];
        _b = myBalances.combinedBalances, combinedCADcurrent = _b[0], combinedUSDcurrent = _b[1];
        _c = myBalances.sodPerCurrencyBalances, perCADstartOfDay = _c[0], perUSDstartOfDay = _c[1];
        _d = myBalances.sodCombinedBalances, combinedCADstartOfDay = _d[0], combinedUSDstartOfDay = _d[1];
        perCurrency = {
            CAD: {
