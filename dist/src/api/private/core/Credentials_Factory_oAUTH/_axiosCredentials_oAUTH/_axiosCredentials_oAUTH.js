...
exports._oAuthAxiosCredentials = function (token) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var _a, refreshToken, credentials, axiosConfig, response;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = _validateToken_1._validateToken(token), refreshToken = _a.refreshToken, credentials = _a.credentials;
                axiosConfig = {
