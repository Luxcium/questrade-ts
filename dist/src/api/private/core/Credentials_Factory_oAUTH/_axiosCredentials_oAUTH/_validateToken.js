...
var _buildCredentialsFromToken_1 = require("../_credentialsFactory/_buildCredentialsFromToken");
exports._validateToken = function (options) {
    var credentials = _buildCredentialsFromToken_1._buildCredentialsFromToken(options);
