...
export declare type Variants = StrategyVariant[];
/**
 * variant ID
 ...
 */
export declare type Strategy = string;
/** array of Strategy legs. Maximum of 4 legs is allowed */
export declare type Legs = [Leg, Leg?, Leg?, Leg?];
/**
...
//# sourceMappingURL=IStrategiesVariants.d.ts.map