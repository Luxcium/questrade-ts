...
// //       console.log(
// //         await qt.allFunctions.get.accounts.activities(startTime)(endTime)
// //       );
// //       console.log(
// //         await qt.allFunctions.get.accounts.orders(startTime)(endTime)('All')
// //       );
// //       console.log(
// //         await qt.allFunctions.get.accounts.executions(startTime)(endTime)
// //       );
// //       console.log(await qt.allFunctions.get.accounts.balances());
// //       console.log(await qt.allFunctions.get.accounts.positions());
// //       // console.log(await qt.allFunctions.get.accounts.allAccounts());
// //       // console.log(await qt.allFunctions.get.accounts.time());
// //       // console.log(
// //       //   await qt.allFunctions.get.markets.candlesById(startTime)(endTime)(
// //       //     'OneDay'
// //       //   )(stockNumericID)
// //       // );
// //       console.log(
// //         '(await qt.allFunctions.get.markets.quotes.byStrategies({variants:[{variantId:1,strategy:"custom",[]}]}));'
// //       );
// //       console.log(
// //         await qt.allFunctions.get.markets.quotes.options({
// //           underlyingId: stockNumericID,
// //           expiryDate: optionExpiryDate,
// //         })
// //       );
// //       // console.log(
// //       //   await qt.allFunctions.get.markets.quotes.options.byIds([
// //       //     optionNumericID,
// //       //   ])
// //       // );
// //       // qt.allFunctions.get.console.log(
// //       //   await qt.allFunctions.get.markets.quotes.byIds([stockNumericID])
// //       // );
// //       // console.log(await qt.allFunctions.get.markets.allMarkets());
// //       console.log(
// //         await qt.allFunctions.get.symbols.optionsById(stockNumericID)
// //       );
// //       console.log(await qt.allFunctions.get.symbols.search(stockStringID));
// //       console.log(
// //         (await qt.allFunctions.get.symbols.search(stockStringID)).count
// //       );
// //       console
// //         .log
// //         // await qt.allFunctions.get.symbols.search.count(stockStringID)
// //         ();
// //       // console.log(await qt.allFunctions.get.symbols.searchAll(stockStringID));
// //       console.log(await qt.allFunctions.get.symbols.byIds([stockNumericID]));
